...
- Build a React + TypeScript mobile longevity prototype with a dark, cinematic wellness palette: ink-black base, deep espresso surfaces, burnished amber / honey-gold accents, warm ivory type, and smoky-tan secondary text.
- The primary Today view greets Maya on Sunday, September 27, 2026 and lists Hydrate, Liposomal Glutathione, Morning Light, Morning Check-in, Meditation, Clinic Visit — Cold Plunge, and Workout.
- Morning Check-in opens as a full-screen voice prompt titled “How's your health?” with a prominent timer below the microphone and a bottom-anchored, equally wide bubble stack: “Find a quiet space.”, “Talk for at least 30 seconds.”, and “Tap the mic when you are ready.” Its subheading includes the wellness-indicator, non-diagnostic disclaimer; do not show a recordings-storage link. Add habit exposes Daily, Weekly, and Custom frequency choices. Today and Trends are the core tabs.
